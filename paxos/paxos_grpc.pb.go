...
const (
	PaxosKV_Prepare_FullMethodName = "/paxos.PaxosKV/Prepare"
	PaxosKV_Accept_FullMethodName  = "/paxos.PaxosKV/Accept"
)
...
func (c *paxosKVClient) Prepare(ctx context.Context, in *Proposer, opts ...grpc.CallOption) (*Acceptor, error) {
	out := new(Acceptor)
	err := c.cc.Invoke(ctx, PaxosKV_Prepare_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paxosKVClient) Accept(ctx context.Context, in *Proposer, opts ...grpc.CallOption) (*Acceptor, error) {
	out := new(Acceptor)
	err := c.cc.Invoke(ctx, PaxosKV_Accept_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
